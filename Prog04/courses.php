...
function printListing($apiCall) {
    ...
    if (!($obj->courses == null)) {
        ...
        foreach ($obj->courses as $course) {
            ...
            if(strcmp(substr($course->meetingTimes[0]->days , 0, 1), 'T') && strcmp(substr($course->meetingTimes[0]->days , 1, 1), 'T'))continue;
        ...
        if(strcmp(substr($course->meetingTimes[0]->days , 0, 1), 'W') && strcmp(substr($course->meetingTimes[0]->days , 1, 1), 'W'))continue;               //elseif (strcmp(substr($course->meetingTimes[0]->days , 1, 1) , 'W'))continue;
        ...
        foreach ($obj->courses as $course) {
            ...
            if(strcmp(substr($course->meetingTimes[0]->days , 0, 1), 'R') && strcmp(substr($course->meetingTimes[0]->days , 1, 1), 'R'))continue;
        ...
        foreach ($obj->courses as $course) {
            ...
            if(strcmp(substr($course->meetingTimes[0]->days , 0, 1), 'F') && strcmp(substr($course->meetingTimes[0]->days , 1, 1), 'F'))continue;
        ...
        foreach ($obj->courses as $course) {
            ...
            if(strcmp($course->meetingTimes[0]->days, ''))continue;       
